...
test("article metadata supports different Turkish and English slugs", () => {
  ...
  const metadata = createPageMetadata({
    ...
    article: { publishedTime: "2026-09-25", modifiedTime: "2026-09-25", authors: ["Adakan Software"] },
  })
  ...
  assert.equal(metadata.openGraph.publishedTime, "2026-09-25")
  assert.equal(metadata.openGraph.modifiedTime, "2026-09-25")
  assert.deepEqual(metadata.openGraph.authors, ["Adakan Software"])
})
