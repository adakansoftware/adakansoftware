...
test("sitemap emits every public locale URL with reciprocal language alternates", () => {
  ...
  assert.deepEqual(projectsEntry.images, [
    "https://adakansoftware.com/projects/optimized/z-grup-insaat-cover.webp",
    "https://adakansoftware.com/projects/optimized/sallihogullari-hafriyat-cover.webp",
    "https://adakansoftware.com/projects/optimized/z-grup-logo.webp",
    "https://adakansoftware.com/projects/optimized/salihogullari-hafriyat-logo.webp",
    "https://adakansoftware.com/projects/optimized/adakan-hafriyat-insaat-logo.webp",
    "https://adakansoftware.com/projects/optimized/adakan-software-logo.webp",
  ])
})

test("sitemap gives every canonical URL an honest modification date without ignored crawl hints", () => {
  const entries = buildSitemapEntries(publicRoutes, baseUrl)
  ...
  for (const entry of entries) {
    ...
    assert.ok(new Date(`${entry.lastModified}T00:00:00.000Z`).getTime() <= Date.now())
