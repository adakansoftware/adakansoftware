...
test("laptop animation releases preload images and pauses while the page is hidden", () => {
  const component = readFileSync(join("components", "laptop-reveal.tsx"), "utf8")

  assert.doesNotMatch(component, /preloadedSpritesRef/)
  assert.match(component, /pendingImages\.delete\(image\)/)
...
test("laptop frames map to a small set of sprite sheets", () => {
  ...
  assert.deepEqual(laptopSpriteFrame(1, "light"), {
    source: "/laptop-sprites/light/sheet-01.webp?v=1",
    backgroundPosition: "0% 0%",
  })
  assert.deepEqual(laptopSpriteFrame(6, "dark"), {
    source: "/laptop-sprites/dark/sheet-01.webp?v=1",
    backgroundPosition: "100% 100%",
  })
  assert.deepEqual(laptopSpriteFrame(7, "light"), {
    source: "/laptop-sprites/light/sheet-02.webp?v=1",
    backgroundPosition: "0% 0%",
  })
})
