...
test("public routes produce unique canonical URLs for both supported locales", () => {
  ...
  assert.deepEqual(
    ...
    ["/", "/about", "/approach", "/blog", ...getBlogPostPaths().map(post => post.tr), "/careers", "/contact", "/demos", "/logo", "/privacy", "/pricing", "/projects", "/services", "/services/software-development", "/services/web-development", "/services/nextjs-development", "/services/web-application-development", "/services/business-automation", "/services/ui-ux-design", "/terms", "/testimonials"],
  )
})
