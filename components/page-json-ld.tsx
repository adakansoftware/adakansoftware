...
export function PageJsonLd({ locale, path, content: contentOverride, serviceTypes, faqs }: { locale: Locale; path: string; content?: { title: string; description: string }; serviceTypes?: string[]; faqs?: Array<{ question: string; answer: string }> }) {
