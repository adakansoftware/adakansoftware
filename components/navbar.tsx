...
export function Navbar({ locale: _locale }: { locale: Locale }) {
  ...
  return <header className="studio-header"><div className="studio-container studio-nav">
    <Link href={withLocale("/", locale)} className="studio-brand" onClick={close} aria-label={locale === "tr" ? "Adakan Software ana sayfa" : "Adakan Software home"}><Image src="/adakan-logo.png" alt="" width={40} height={40} priority /><span>Adakan<span className="studio-brand-secondary"> Software</span></span></Link>
